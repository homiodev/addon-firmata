...
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_CONFIG_REQUEST;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_DELAY_REQUEST_BIT;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_READ_REQUEST_BIT;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_RESET_REQUEST_BIT;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_SEARCH_ALARMS_REQUEST;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_SEARCH_REPLY;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_SEARCH_REQUEST;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_SELECT_REQUEST_BIT;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_WITHDATA_REQUEST_BITS;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.ONEWIRE_WRITE_REQUEST_BIT;
import static org.homio.bundle.firmata.provider.util.OneWireUtils.to7BitArray;
...
import org.homio.bundle.firmata.provider.util.OneWireDevice;
