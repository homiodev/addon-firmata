...
public class Scratch3FirmataOneWireBlocks extends Scratch3FirmataBaseBlock {
  ...
  public Scratch3FirmataOneWireBlocks(EntityContext entityContext, FirmataBundleEntrypoint firmataBundleEntrypoint) {
    super("#83A044", entityContext, firmataBundleEntrypoint, "onewire");
